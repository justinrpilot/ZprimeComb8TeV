void line_r(){
  ...
  double x1 = 0.70;
  double x2 = 1.;
  double y1 = TMath::Log10(0.794);
  double y2 = TMath::Log10(0.628);
  ...
  double x3 = 0.70;
  double x4 = 1.;
  double y3 = TMath::Log10(1.73045); // expected limit from combo at 0.70
  double y4 = TMath::Log10(0.42515); // expected limit from combo at 1.0
  ...
  double o1 = TMath::Log10(0.719); // observed 0.70
  double o2 = TMath::Log10(0.759); // observed 1
  ...
  double u168 = TMath::Log10(0.794+0.294);
  double u268 = TMath::Log10(0.628+0.241);
  double k = (u168-u268)/(x3-x4);
  double d = 0.5 * ((u268+u168) - k*(x3+x4));
  double u68 = TMath::Power(10,k*x + d);

  double l168 = TMath::Log10(0.794-0.225);
  double l268 = TMath::Log10(0.628-0.169);
  k = (l168-l268)/(x3-x4);
  d = 0.5 * ((l268+l168) - k*(x3+x4));
  double l68 = TMath::Power(10,k*x + d);

  double u195 = TMath::Log10(0.794+0.674);
  double u295 = TMath::Log10(0.628+0.514);
  double k = (u195-u295)/(x3-x4);
  double d = 0.5 * ((u295+u195) - k*(x3+x4));
  double u95 = TMath::Power(10,k*x + d);

  double l195 = TMath::Log10(0.794-0.379);
  double l295 = TMath::Log10(0.628-0.296);
  k = (l195-l295)/(x3-x4);
